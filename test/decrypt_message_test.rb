...
class DecryptMessageTest < Minitest::Test
  ...
  def test_it_can_create_message_object
    d = DecryptMessage.new
    actual = d.instantiate_message("y5V*m7HgKZH#pZ;", 12345, Date.new(2017, 03, 28))
    assert_instance_of Message, actual
  end
  def test_it_can_get_offset
    d = DecryptMessage.new
    d.instantiate_message("y5V*m7HgKZH#pZ;", 12345, Date.new(2017, 03, 28))
    d.get_offset
  ...
  def test_it_can_decrypt_message
    d = DecryptMessage.new
    d.instantiate_message("y5V*m7HgKZH#pZ;", 12345, Date.new(2017, 03, 28))
    assert_equal "Message: message ..end... Decrypted with key: 12345 and date: 2017-03-28", d.decrypt
  end
end
